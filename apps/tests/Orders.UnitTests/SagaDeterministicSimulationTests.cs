...
/// <summary>Complements the TLA+ exhaustive proof with a FoundationDB/TigerBeetle-style deterministic simulation of the saga state machine's NoResurrection property under a seeded pseudo-random schedule.</summary>
public sealed class SagaDeterministicSimulationTests
{
    ...
    /// <summary>Drives one simulated saga run: a fixed pool of events delivered in an order determined entirely by <paramref name="seed"/>.</summary>
