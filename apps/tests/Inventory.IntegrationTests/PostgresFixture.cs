...
/// <summary>One PostgreSQL container shared by every test class in this project via PostgresCollectionDefinition; isolation comes from a unique schema per test-class instance rather than a dedicated container.</summary>
