...
/// <summary>
/// Reservation command/reply contracts for Inventory.Service.
...
public sealed record InventoryReservationReplied(
    ...
    // Distinguishes "wait for a restock" from "give up" -
...
/// <summary>
/// How a reservation is settled - Commit makes the hold
...
/// <summary>
/// A warehouse has fallen to or below its reorder point.
...
///
/// EventId is what finally consumes this signal -
...
/// <summary>
/// An order sitting in <see cref="OrderStatuses.Backordered"/>
...
/// several waiting lines, and the FIFO release path
