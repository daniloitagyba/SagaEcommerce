...
/// <summary>
/// The orchestrated saga's command/reply contracts. Plain JSON,
...
public sealed record PaymentDecisionRequested(
    ...
    // Lets the orchestrated payment step run the same
    ...
    string CustomerId = "",
    // Same carry-through as CustomerId - issued at step 2
