...
namespace Orders.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260816190919_AddPromotionCampaigns")]
    partial class AddPromotionCampaigns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders.Domain.OrderSummary", b =>
                {
                    ...
                    b.HasIndex("ProjectedAt", "OrderId")
                        .IsDescending()
                        .HasDatabaseName("ix_order_summaries_projected_at_order_id");

                    b.HasIndex("CustomerId", "ProjectedAt", "OrderId")
            ...
            modelBuilder.Entity("Orders.Domain.PromotionCampaign", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
            ...
            modelBuilder.Entity("Orders.Domain.PromotionCampaignClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("promotion_campaign_claims", (string)null);
                });

            modelBuilder.Entity("Orders.Domain.SagaOrchestrationLine", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uuid")
                        .HasColumnName("order_id");
                    ...
                    b.HasKey("OrderId", "LineIndex");

                    b.HasIndex("ReservationId")
                        .IsUnique()
                        .HasDatabaseName("ix_saga_orchestration_lines_reservation_id");

                    b.ToTable("saga_orchestration_lines", (string)null);
                });
            ...
            modelBuilder.Entity("Orders.Domain.SagaOrchestrationLine", b =>
                {
                    b.HasOne("Orders.Domain.SagaOrchestrationState", null)
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
