...
/// <summary>Risk scoring policy, kept in configuration so thresholds can be tuned without a redeploy.</summary>
public sealed class PaymentRiskOptions
{
    ...
    /// <summary>Caps how many of the customer's payments VELOCITY/ADDRESS_MISMATCH/ATYPICAL_AMOUNT load.</summary>
    ...
    /// <summary>How long an approved payment of this method may sit unsettled.</summary>
