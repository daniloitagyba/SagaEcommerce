...
| Real backup/restore | Workflow [31973821277](https://github.com/daniloitagyba/SagaEcommerce/actions/runs/31973821277) | MongoDB: 9 products and 4 categories, backup 1 s, restore 3 s, measured RPO 0 records. Redis: 45 keys, backup 0 s, restore 2 s, measured RPO 0 keys. Evidence retention is 365 days. |
