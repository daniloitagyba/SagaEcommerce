...
- **Cart contents now drive inventory reservation.** Milestone 66 moved checkout to line items, server-side catalog pricing, and real SKU reservation. The public amount-only checkout shape was removed on 2026-08-17.
